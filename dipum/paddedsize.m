...
%   vectors, computes the two-element size vector PQ. The
%   elements of PQ are the smallest even integers greater than or
%   equal to AB + CD -1.
%
%   PQ = PADDEDSIZE(AB, CD, 'PWR2') computes the vector PQ such
%   that PQ(1) = PQ(2) = 2^nextpow2(2*m), where m is MAX([AB
%   CD]).
